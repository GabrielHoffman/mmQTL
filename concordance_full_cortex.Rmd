...
ggplot(df_melt, aes(factor(eQTL_order), value, fill=variable)) + geom_bar(stat="identity", position="dodge") + theme_classic() + scale_y_continuous(expand=c(0, 0), limits=c(NA, 1)) +  xlab("eQTL degree") + ylab(bquote(Storeys~pi[1])) + scale_fill_brewer(name="Discovery", palette="Set1")
```
